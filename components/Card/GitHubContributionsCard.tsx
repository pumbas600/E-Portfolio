  ...
  return (
    <ProjectCard
      ...
      description={
        <>
          <p>
            GitHub Contributions is a simple API I made that can generated
            dynamic graphs of your recent GitHub contributions which can be used
            as image URLs in markdown files (Such as your public profile
            README). The API supports a number of query parameters which allow
            the style of the graph to be completely customised to get the style
            desired by users.
          </p>
          <p>
            It uses Next.JS for the API, React for rendering the contribution
            graph, Firestore for tracking usage metrics, and is hosted on an
            Oracle Cloud Infastructure compute instance.
          </p>
          <div className="flex flex-col">
            <div>
              <b className="text-xl dark:text-teal-200 text-sky-600">
                {formatMetric(pastWeekCalls)}
              </b>
              &nbsp;graphs rendered in the past week.
            </div>
            <div>
              <b className="text-xl dark:text-teal-200 text-sky-600">
                {formatMetric(totalCalls)}
              </b>
